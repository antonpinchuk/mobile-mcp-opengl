// Default vision provider: Runware.ai `imageCaption` task. Chosen because it
// hosts Qwen2.5-VL-7B-Instruct directly (AIR id runware:152@2) at a measured
...
const DEFAULT_MODEL_AIR = 'runware:152@2'; // Qwen2.5-VL-7B-Instruct
